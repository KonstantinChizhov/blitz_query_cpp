...
namespace blitz_query_cpp
{
    ...
    public:
        ...
        token_t next_token()
        {
            ...
            case '\0':
                ...
                return token_t(token_type::End);
            case '{':
                return token_t(query.substr(current_pos, 1), current_pos++, 1, token_type::LBrace);
            case '}':
                return token_t(query.substr(current_pos, 1), current_pos++, 1, token_type::RBrace);
            case '(':
                return token_t(query.substr(current_pos, 1), current_pos++, 1, token_type::LParen);
            case ')':
                return token_t(query.substr(current_pos, 1), current_pos++, 1, token_type::RParen);
            case ':':
                return token_t(query.substr(current_pos, 1), current_pos++, 1, token_type::Colon);
            case ',':
                return token_t(query.substr(current_pos, 1), current_pos++, 1, token_type::Comma);
            case '.':
                return handle_dot();
            case '=':
                return handle_eq();
    ...
    private:
        ...
        token_t handle_dot()
        {
            ...
            return token_t(query.substr(current_pos, 1), current_pos++, 1, token_type::MemberAccess);
        }
        ...
        token_t read_name(index_t skipChars, token_type type)
        {
            ...
            return token_t(query.substr(start_pos, len), current_pos, len, type);
        }
        ...
        token_t read_comment()
        {
            ...
            index_t len = current_pos - start_pos;
            return token_t(query.substr(start_pos, len), current_pos, len, token_type::Comment);
        }
